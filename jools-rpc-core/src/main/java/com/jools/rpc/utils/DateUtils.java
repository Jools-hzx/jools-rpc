 ...
 * @description: 阿里云开发者 - 时间工具类
 * from:https://mp.weixin.qq.com/s/J-pmgYFRBXIABSfBB_Ax2w
 */
public class DateUtils {

    public static final String DEFAULT_FORMAT = "yyyy-MM-dd HH:mm:ss";
    public static final Locale DEFAULT_LOCATION = Locale.CHINA;
    ...
    public static String formatLocalTimeDate(LocalDateTime localDateTime) {
        return formatLocalTimeDate(localDateTime, DEFAULT_FORMAT, DEFAULT_LOCATION);
    }

    public static String formatLocalTimeDate(LocalDateTime localDateTime, String pattern) {
        return formatLocalTimeDate(localDateTime, pattern, DEFAULT_LOCATION);
    }

    public static String formatLocalTimeDate(LocalDateTime localDateTime, Locale locale) {
        return formatLocalTimeDate(localDateTime, DEFAULT_FORMAT, locale);
    }

    public static String formatLocalTimeDate(LocalDateTime localDateTime, String pattern, Locale locale) {
        DateTimeFormatter zhFormatter = DateTimeFormatter.ofPattern(pattern, locale);
        return zhFormatter.format(localDateTime);
    }
